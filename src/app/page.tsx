...
export default function Home() {
    return (
        <div className="w-full flex flex-col items-center justify-center">
            <NavBar />
            <div className="w-full md:grid sm:hidden lg:grid-cols-3lg md:grid-cols-2lg gap-6 px-5 mt-8">
                <div className="flex flex-col justify-end items-start gap-y-4 flex-1">
                    ...
                    <div className="w-full flex flex-wrap items-end justify-between mt-2">
                        ...
                        <div className="flex flex-row items-center text-xs justify-center bg-bgInputSearch rounded-md gap-x-2 px-3 py-2 mt-2">
                            <p>Supported by</p>
                    ...
                    <div className="w-full sm:h-54 flex flex-row items-center justify-between bg-bgInputSearch rounded-md hover:bg-bgHover hover:shadow-sm hover:shadown-bgHover py-2">
                        ...
                        <input
                            ...
                            className="w-full flex-1 text-15px border-0 outline-none bg-transparent p-2"
                        />
                ...
                <div className="lg:flex lg:flex-col md:hidden h-280 bg-bgSection rounded-md p-5 items-start justify-between">
            ...
            <div className="w-full px-3 sm:flex md:hidden flex-col gap-y-4">
                <h1 className="text-2xl font-bold leading-5 text-textSecondary mt-10">
                    Unsplash
                </h1>
                <div className="w-full overflow-hidden flex flex-row items-center justify-between slider">
                    ...
                    >
                        <SwiperSlide>
                            ...
                            >
                                <div
                                    className="h-full w-full flex flex-col items-start justify-end p-5 text-white rounded-md"
                                    style={{
                                        background:
                                            "linear-gradient(0deg,#000000a6,#0000 55%)",
                                    }}
